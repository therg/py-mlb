...
class DB:
    ...
    def query(self, columns, table, matchColumn=None, matchValue=None):
        """
        Executes a search query
        SELECT [<columns>] FROM <table> WHERE <matchColumn>='<matchValue>';
        ...
        return queryResult.fetch_row(maxrows=0)
